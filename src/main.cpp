...
uint256 hashGenesisBlock("0x4937bfaff2c0ed4ef32b0b6f822030aab330f9d62240f72c42dfb7d03c4978de");
...
const string strMessageMagic = "Goodbyecoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
	...
	if(nHeight == 1){nSubsidy = 10000 * COIN;} 
    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 50000); // Litecoin: 840k blocks in ~4 years

    return nSubsidy + nFees;}

static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // Goodbyecoin: 2 days
static const int64 nTargetSpacing = 120; // Goodbyecoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal goodbyecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Goodbyecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Goodbyecoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1385680000; //epochtime
        ...
        assert(block.hashMerkleRoot == uint256("0xb83940b59aa7d5d282a0c71f2645b0d512a5461591778dd327cc6375487a6b72"));
...
unsigned char pchMessageStart[4] = { 0x04, 0xd9, 0xdd, 0x02 };
